...
- (void)drawRect:(CGRect)rect
{
    ...
    UIRectFill(CGRectMake(borderWidth, borderWidth, 2.0f, height -2*borderWidth));
    UIRectFill(CGRectMake(borderWidth, borderWidth, width -2*borderWidth, 2.0f));
    UIRectFill(CGRectMake(borderWidth, height - borderWidth, width -2*borderWidth+2.0, 2.0f));
    UIRectFill(CGRectMake(width - borderWidth, borderWidth, 2.0f, height -2*borderWidth));
