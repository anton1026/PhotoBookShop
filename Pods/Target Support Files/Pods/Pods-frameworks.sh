...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/BABCropperView.framework"
  install_framework "Pods/HTKDragAndDropCollectionViewLayout.framework"
  install_framework "Pods/JTObjectMapping.framework"
  install_framework "Pods/LXReorderableCollectionViewFlowLayout.framework"
